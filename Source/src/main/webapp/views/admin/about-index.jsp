                    ...
                    <div class="row">
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <c:forEach items='${requestScope["list"]}' var='about'>
                                <tr class="tr-shadow">
                                    <td>${about.title}</td>
                                    <td>${about.shortContent}</td>
                                    <td>
                                        <div class="table-data-feature">

                                            <a href="admin-about?action=edit&id=${about.id}"
                                               class="item" data-toggle="tooltip" data-placement="top"
                                               title="Edit"> <i class="zmdi zmdi-edit"></i>
                                            </a> <a href="admin-about?action=delete&id=${about.id}"
                                                    class="item" data-toggle="tooltip" data-placement="top"
                                                    title="Delete"> <i class="zmdi zmdi-delete"></i>
                                        </a> <a href="admin-about?action=view&id=${about.id}"
                                                class="item" data-toggle="tooltip" data-placement="top"
