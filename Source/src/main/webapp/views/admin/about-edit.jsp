                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <h3 class="title-5 m-b-35">About Manager</h3>
                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="title" name="title" placeholder="Title"
                                                   required  class="form-control" value="${about.title}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="shortContent" name="shortContent" placeholder="ShortContent"
                                                   required  class="form-control" value="${about.shortContent}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="content" class=" form-control-label">Full-Content</label>
                                        </div>
                                        <div class="col-12 col-md-9">
												<textarea id="content" name="content"
                                                          placeholder="Content"  rows=4
                                                          class="form-control"  value="${about.content}">${about.content}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="imageUrl" name="imageUrl" placeholder="ImageUrl"
                                                   required  class="form-control"  value="${about.imageUrl}">
                                        </div>
                                    </div>
