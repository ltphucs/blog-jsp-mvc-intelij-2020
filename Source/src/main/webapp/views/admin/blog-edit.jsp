        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    ...
                    <li><a href="admin-about"> <i class="far fa-check-square"></i>Quản
                        lý About
                    </a></li>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="title" name="title" placeholder="Title"
                                                   required  class="form-control" value="${blog.title}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="shortContent" name="shortContent" placeholder="ShortContent"
                                                   required  class="form-control" value="${blog.shortContent}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
												<textarea id="fullContent" name="fullContent"
                                                          placeholder="fullContent"  rows=4
                                                          class="form-control"  value="${blog.fullContent}">${blog.fullContent}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="imageUrl" name="imageUrl" placeholder="ImageUrl"
                                                   required  class="form-control"  value="${blog.imageUrl}">
                                        </div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="idCategory" class=" form-control-label">Category</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            ...
                                            <select class="form-control" id="idCategory" name="idCategory" required>
                                                ...
                                                <c:forEach	items='${requestScope["cateList"]}' var='cate'>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${cate.id==blog.idCategory}">
